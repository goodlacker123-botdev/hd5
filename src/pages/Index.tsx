    ...
    <div className="min-h-screen relative overflow-hidden">
      ...
      <div className="relative z-10 min-h-screen flex flex-col">
        ...
        <header className="py-8 md:py-12 text-center">
          ...
          >
            ✦ SOMETHING STIRS BENEATH THE ASHES ✦
          </div>
        </header>
        ...
        <main className="flex-1 flex flex-col items-center justify-center px-4 pb-16 gap-8">
          ...
          <div className="flex flex-wrap justify-center gap-3 sm:gap-4 max-w-xs sm:max-w-none">
            ...
            <a
              href="https://www.facebook.com/haydendavisoff"
              target="_blank"
              rel="noopener noreferrer"
              className="w-12 h-12 rounded-full flex items-center justify-center transition-all duration-300 hover:scale-110"
              style={{
        ...
        <footer className="py-6 text-center px-4">
          ...
          >
            Countdown Ends {targetDate.toLocaleString('en-US', { timeZone: 'America/New_York', month: 'long', day: 'numeric' })} at {targetDate.toLocaleString('en-US', { timeZone: 'America/New_York', hour: 'numeric', minute: '2-digit', hour12: true }).replace(' ', '')} ET
          </div>
        </footer>
      </div>
    </div>
